    ...
    return (
      <main className="admin-page">
        <section className="admin-card">
          ...
          {resolvedSearchParams.error ? <p className="form-status form-status-error">That password did not match.</p> : null}
          <p className="microcopy">
            Set <code>ADMIN_ACCESS_KEY</code>, <code>SUPABASE_URL</code>, and <code>SUPABASE_SERVICE_ROLE_KEY</code> in
            deployment settings to make this live and secure.
          </p>
